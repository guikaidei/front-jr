...
export function VisualizaMatematica() {
    ...
    const fetchData = async () => {
        ...
        try {
            const avisosResponse = await axios.get('http://127.0.0.1:5000/listar-avisos/matematica', {
                headers: { Authorization: `Bearer ${token}` },
            });
            setAvisos(avisosResponse.data.avisos);

            const conteudosResponse = await axios.get('http://127.0.0.1:5000/listar-conteudos/matematica', {
                headers: { Authorization: `Bearer ${token}` },
            });
...
export default VisualizaMatematica;
